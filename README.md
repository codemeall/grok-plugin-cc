...
- `/grok:adversarial-review` asks Grok to challenge architecture, reliability, security, scale, and assumptions.
- `/grok:rescue <task>` asks Grok to investigate or propose an implementation for a specific task.
